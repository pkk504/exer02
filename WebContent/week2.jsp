...
import ="java.text.SimpleDateFormat"
     ...
     long b =dd.getDay();
		long bb=(b)*1000*60*60*24;
		java.sql.Date dd2 = new java.sql.Date(tt-(bb));
     %>
<!DOCTYPE html>
<html>
<head>
...
<p>
<a href="/"><button type="button">되돌아가기</button></a><br/>
<b><H2> !!주간 랭킹!! </H2></b><br/>
<%
try {
	// step1 . connect
...
String sql =  "select*from baseresult where logdate between to_date('"+dd2+" 00:00;01','YYYY-MM-DD HH24:MI:SS') and to_date('"+dd+" 23:59:59','YYYY-MM-DD HH24:MI:SS') order by tried asc,elapsed asc" ;
